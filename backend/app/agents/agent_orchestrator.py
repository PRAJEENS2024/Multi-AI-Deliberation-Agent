...
async def run_jury_workflow(session_id: str):
    ...
    try:
        ...
        # We simulate selecting 3 models
        state.models_selected = ["gemini-1.5-pro", "gpt-4o", "claude-3.5-sonnet"]
        ...
        for model in state.models_selected:
            system_prompt = f"Answer the user's prompt thoughtfully and accurately. Focus on your distinct {model} perspective."
