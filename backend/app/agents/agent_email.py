...
async def compose_and_send_email(
    ...
    try:
        ...
        subject = f"⚖️ AI Jury Report: {prompt[:50]}..."
        body_plain = f"""AI JURY DELIBERATION REPORT
Query: {prompt}
...
<html><body style="font-family:Segoe UI,sans-serif;background:#09090b;color:#f4f4f5;margin:0;padding:24px">
