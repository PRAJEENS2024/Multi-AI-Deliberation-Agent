...
export const Profile: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070A14] text-gray-100 p-6 md:p-10 font-sans">
      <div className="max-w-4xl mx-auto">
        {/* Header Navigation */}
        <div className="flex items-center justify-between mb-8">
          <button
            onClick={() => navigate('/chat')}
            className="flex items-center gap-2 text-xs font-medium text-gray-400 hover:text-white transition-colors bg-gray-900/60 border border-white/10 px-3 py-2 rounded-xl"
          >
            <ArrowLeft className="w-4 h-4" />
            Back to Deliberation Workspace
          </button>
